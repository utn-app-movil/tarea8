...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnLoginHistory: Button = findViewById(R.id.main_btnLoginHistory)
        btnLoginHistory.setOnClickListener(View.OnClickListener { view ->
            openActivity(LoginHistoryActivity::class.java)
        })
